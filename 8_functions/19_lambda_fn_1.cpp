// this is similar to the lambda function in c++, almost similar to that only. but it way more complex then that.
...
// ---------------------> this full code break down sub parts in coming files.
